...
CodeWriter::CodeWriter(const std::string output_file) {
  output_stream_.open(output_file, std::ios::app);
  if (!output_stream_) {
...
void CodeWriter::WriteLabel(const std::string label) {
  output_stream_ << "(" << label << ")" << std::endl;
}

void CodeWriter::WriteGoto(const std::string label) {
  output_stream_ << "// goto " << label << std::endl;
  output_stream_ << "@" << label << std::endl;
  output_stream_ << "0;JMP" << std::endl;
}

void CodeWriter::WriteIf(const std::string label) {
  output_stream_ << "// if-goto " << label << std::endl;
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "M=M-1" << std::endl;
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "A=M" << std::endl;
  output_stream_ << "D=M" << std::endl;
  output_stream_ << "@" << label << std::endl;
  output_stream_ << "D;JNE" << std::endl;
}

void CodeWriter::WriteCall(const std::string function_name, const int num_args) {
  output_stream_ << "// call " << function_name << " " << num_args << std::endl;

  // push return address
  output_stream_ << "@return" << return_count_ << std::endl;
  output_stream_ << "D=A" << std::endl;
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "A=M" << std::endl;
  output_stream_ << "M=D" << std::endl;
  ...
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "D=M" << std::endl;
  output_stream_ << "@" << num_args << std::endl;
  output_stream_ << "D=D-A" << std::endl;
  output_stream_ << "@5" << std::endl;
  output_stream_ << "D=D-A" << std::endl;
  output_stream_ << "@ARG" << std::endl;
  output_stream_ << "M=D" << std::endl;
  ...
  output_stream_ << "@LCL" << std::endl;
  output_stream_ << "M=D" << std::endl;
  output_stream_ << "@" << function_name << std::endl;
  output_stream_ << "0;JMP" << std::endl;
  output_stream_ << "(return" << num_args << ")" << std::endl;

  return_count_++;
}

void CodeWriter::WriteFunction(const std::string function_name, const int num_locals) {
  output_stream_ << "// function " << function_name << " " << num_locals
    << std::endl;
...
void CodeWriter::WriteReturn() {
  output_stream_ << "// return" << std::endl;

  output_stream_ << "// memory[13] <- memory[LCL]" << std::endl;
  output_stream_ << "@LCL" << std::endl;
  output_stream_ << "D=M" << std::endl;
  output_stream_ << "@R13" << std::endl;
  output_stream_ << "M=D" << std::endl;

  output_stream_ << "// memory[14] <- memory[memory[R13]-5]" <<std::endl;
  output_stream_ << "@5" << std::endl;
  output_stream_ << "D=A" << std::endl;
  output_stream_ << "@R13" << std::endl;
  output_stream_ << "A=M-D" << std::endl;
  output_stream_ << "D=M" << std::endl;
  output_stream_ << "@R14" << std::endl;
  output_stream_ << "M=D" << std::endl;

  output_stream_ << "// memory[SP] -= 1" <<std::endl;
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "M=M-1" << std::endl;

  output_stream_ << "// memory[memory[ARG]] <- memory[memory[SP]]" << std::endl;
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "A=M" << std::endl;
  output_stream_ << "D=M" << std::endl;
  output_stream_ << "@ARG" << std::endl;
  ...
  output_stream_ << "// memory[SP] <- memory[ARG] + 1" << std::endl;
  output_stream_ << "@ARG" << std::endl;
  output_stream_ << "D=M+1" << std::endl;
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "M=D" << std::endl;

  output_stream_ << "// memory[THAT] <- memory[memory[R13]-1]" <<std::endl;
  output_stream_ << "@1" << std::endl;
  output_stream_ << "D=A" << std::endl;
  output_stream_ << "@R13" << std::endl;
  output_stream_ << "A=M-D" << std::endl;
  output_stream_ << "D=M" << std::endl;
  ...
  output_stream_ << "// memory[THIS] <- memory[memory[R13]-2]" << std::endl;
  output_stream_ << "@2" << std::endl;
  output_stream_ << "D=A" << std::endl;
  output_stream_ << "@R13" << std::endl;
  output_stream_ << "A=M-D" << std::endl;
  output_stream_ << "D=M" << std::endl;
  ...
  output_stream_ << "// memory[ARG] <- memory[memory[R13]-3]" << std::endl;
  output_stream_ << "@3" << std::endl;
  output_stream_ << "D=A" << std::endl;
  output_stream_ << "@R13" << std::endl;
  output_stream_ << "A=M-D" << std::endl;
  ...
  output_stream_ << "// memory[LCL] <- memory[memory[R13]-4]" << std::endl;
  output_stream_ << "@4" << std::endl;
  output_stream_ << "D=A" << std::endl;
  output_stream_ << "@R13" << std::endl;
  output_stream_ << "A=M-D" << std::endl;
  output_stream_ << "D=M" << std::endl;
  ...
  output_stream_ << "// goto memory[R14]" << std::endl;
  output_stream_ << "@R14" << std::endl;
  output_stream_ << "A=M" << std::endl;
  output_stream_ << "0;JMP" << std::endl;
}

void CodeWriter::SaveState(std::string register_name) {
  output_stream_ << "@" << register_name << std::endl;
  output_stream_ << "D=M" << std::endl;
  output_stream_ << "@SP" << std::endl;
  output_stream_ << "A=M" << std::endl;
  output_stream_ << "M=D" << std::endl;
